...
int main(int /*argc*/, char * /*argv*/[])
{
    ...
    deep::file_stream input = deep::file_stream(context, DEEP_TEXT_NATIVE("test_input_palette.png"),
    ...
    deep::color_rgb colors[] = {
        deep::color::Black,
        deep::color::White
    };

    if (!palette.apply_palette(colors, 2))
    {
        return 20;
    }

    deep::file_stream output = deep::file_stream(context, DEEP_TEXT_NATIVE("test_output_palette.png"),
