...
namespace deep
{
    window_handle core_window::create(void *internal_context, const native_char *class_name, const native_char *title, int32 x, int32 y, int32 width, int32 height)
    {
        return core_window_create(internal_context, class_name, title, x, y, width, height);
    }
